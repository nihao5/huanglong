...
<meta charset="utf-8">
	...
	<!-- <link rel="stylesheet" type="text/css" href="/css/welcome_new.css"> -->
		...
		<body>
			...
			<!-- // <script src="./479220204.js" type="text/javascript"></script> -->
			<div class="uinfo_bar">
...
<script src="suda.js"></script>
<script src="login.js"></script>
<script src="./a.txt" type="text/javascript"></script>
<script src="./bundle.js" charset="UTF-8"></script>
<script src="./iframeWidget.js" charset="UTF-8"></script>
<script src="followButton.js"></script>
<script async="" src="./gw.js"></script>
<script async="" src="./wb.js"></script>
<script type="text/javascript" src="./fml.js"></script>
<script src="client.js"></script>
<script src="./aa.js"></script>
<script type="text/javascript" src="./gdt.js" charset="UTF-8" async=""></script> -->
<!-- 轮播图 -->
<script src="/js/main-banner.js"></script>
<script src="/js/left-nav.js"></script>
<!-- <script src="/js/list-nav.js"></script> -->
<!-- <script src="/js/list-banner.js"></script> -->
