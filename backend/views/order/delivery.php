...
?>        
        ...
        ?>
            ...
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header">已发货订单 <small>header small text goes here...</small></h1>
            <!-- end page-header -->
                                ...
                                <table id="data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php foreach($list as $value): ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a href="<?= Url::toRoute(['order/edit-delivery','id'=>$value['id'],'state'=>$value['state']+1]);?>"
                                                   class="btn btn-success m-r-5" onclick="return confirm('确定收货吗?')">客户收货</a>
