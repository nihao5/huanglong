...
<head>
    ...
    <link href="/wnmp/yii2test/backend/web/assets/css/theme/default.css" rel="stylesheet" id="theme" />
    <!-- ================== END BASE CSS STYLE ================== -->
...
<body class="pace-top">
    ...
    <div class="login-cover">
        <div class="login-cover-image"><img src="/wnmp/yii2test/backend/web/assets/img/login-bg/bg-1.jpg" data-id="login-cover-image" alt="" /></div>
    ...
    <div id="page-container" class="fade">
            ...
            <div class="login-content">
                <form action="index.html" method="POST" class="margin-bottom-0">
                    <div class="form-group m-b-20">
                        <input id="userName" type="text" class="form-control input-lg" placeholder="Email Address" />
                        <input type="hidden" id="_csrf" name="_csrf" value="<?php echo yii::$app->request->csrfToken;?>">
                    </div>
                    <div class="form-group m-b-20">
                        <input type="password" class="form-control input-lg" placeholder="Password" />
                    </div>
                    <div id="login-error" class="form-group m-b-20" style="display:none;"></div>
                    ...
                    <div class="m-t-20">
                        Not a member yet? Click <a href="http://www.mls.com/user/register">here</a> to register.
                    </div>
                </form>
            </div>
        </div>
        ...
        <ul class="login-bg-list">
            <li class="active">
                <a href="#" data-click="change-bg">
                    <img src="/wnmp/yii2test/backend/web/assets/img/login-bg/bg-1.jpg" alt="" />
                </a>
            </li>
            <li><a href="#" data-click="change-bg"><img src="/wnmp/yii2test/backend/web/assets/img/login-bg/bg-2.jpg" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="/wnmp/yii2test/backend/web/assets/img/login-bg/bg-3.jpg" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="/wnmp/yii2test/backend/web/assets/img/login-bg/bg-4.jpg" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="/wnmp/yii2test/backend/web/assets/img/login-bg/bg-5.jpg" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="/wnmp/yii2test/backend/web/assets/img/login-bg/bg-6.jpg" alt="" /></a></li>
        </ul>
        ...
        <div class="theme-panel">
            ...
            <div class="theme-panel-content">
                ...
                <div class="row m-t-10">
                    <div class="col-md-12">
                        <a href="login_v2.html#" class="btn btn-inverse btn-block btn-sm" data-click="reset-local-storage"><i class="fa fa-refresh m-r-3"></i> Reset Local Storage</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="/wnmp/yii2test/backend/web/assets/js/login-v2.demo.min.js"></script>
    ...
    <script>
        ...
        $("button[type='submit']").click(function(){
            var url = "<?php echo Url::toRoute(['login/index']);?>";
            var locationUrl = "<?php echo Url::toRoute(['goods/index']);?>";
            ...
            $.ajax({
                ...
                dataType:'json',
                cache:false,
                data:{_csrf:_csrf,'username':username,'password':password},
                success:function(data){
                    if (!data.status) {
                        $("#login-error").css('display','block');
                        $("#login-error").html(data.note);
                    } else {
