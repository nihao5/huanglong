                            ...
                            <form action="<?= Url::toRoute(['link/edit','id'=>$list['id']]);?>" method="post" class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        name="url" value="<?= $list['url'];?>" placeholder="Required" data-parsley-required="true" />
                                        <input type="hidden" id="_csrf" name="_csrf" value="<?php echo yii::$app->request->csrfToken;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-4" for="email">图片地址 :</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="text" value="<?= $list['img'];?>" id="email" name="img" placeholder="图片地址" />
                                    </div>
                                </div>
                                <div class="form-group">
