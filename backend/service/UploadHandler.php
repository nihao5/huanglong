...
class UploadHandler
{
    ...
    function __construct($gid, $path, $options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            'gid' => $gid,
    ...
    // {
    //     return GoodsImgService::showImg($this->options['gid']);
    // }
...
//获取文件名称
    ...
    //重命名
    protected function rename_file_name()
    {
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file = new \stdClass();
        $name = $this->rename_file_name();//重命名
        $file->name = $this->get_file_name($uploaded_file, $name, $size, $type, $error,
            $index, $content_range);
        // 插入数据库
        // $path = $this->options['upload_dir'].$file->name;
        // $goodsImg = GoodsImgService::insertImg($this->options['gid'],$path);
        // if (!$goodsImg) {
        //     return false;
        // }
    ...
    public function delete($print_response = true) {
        ...
        foreach($file_names as $file_name) {
            // GoodsImgService::insertImg(8,$file_name);exit;
            $file_path = $this->get_upload_path($file_name);
